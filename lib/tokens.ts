...
export type KindSpec = {
  label: string;
  /** short English noun used by the prompt generator */
  noun: string;
  category: Category;
  paletteIcon: string;
...
export const KIND_SPEC: Record<Kind, KindSpec> = {
  ...
  card: {
    ...
    hasFill: true,
    defLabel: "Card headline",
    defIcon: "image",
    defSupporting: "Supporting text goes here.",
    defSize: CONTENT_W,
    defVariant: "tonal",
  },
  listItem: {
  ...
  dialog: {
    ...
    defLabel: "Confirm",
    defIcon: "info",
    defSupporting: "Do you want to continue?",
  },
  snackbar: {
    label: "Snackbar",
    noun: "snackbar",
  ...
  linearProgress: {
    ...
    noun: "linear progress indicator",
    category: "progress",
  ...
  circularProgress: {
    ...
    noun: "circular progress indicator",
    category: "progress",
