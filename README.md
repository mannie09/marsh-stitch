...
- **Export & Code Generation** – copy the AI prompt (edit it by hand first if you like), export clean YAML code formatted for **Microsoft Power Automate** & Power Apps workflows (or full declarative UI specifications), download `.yaml` files directly, or save screens as PNG.
