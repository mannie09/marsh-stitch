    ...
    <div className="no-scrollbar" style={{ height: "100%", overflowY: "auto", padding: "12px 12px 20px" }}>
      ...
      >
        ...
        <div style={{ flex: 1, fontSize: 12, lineHeight: 1.5 }}>
          <div style={{ fontWeight: 700, fontSize: 13, marginBottom: 2 }}>Developing Phase</div>
          <div>AI features and model connectors are currently in the developing phase. Underlying configurations are preserved below.</div>
        </div>
      </div>

      <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: 0.4, color: p.onSurfaceVariant, padding: "4px 6px 12px" }}>{t("aiSettings", lang)}</div>
