...
const Beta = ({ p }: { p: Palette }) => (
  <span style={{ fontSize: 10, fontWeight: 700, padding: "2px 8px", borderRadius: 8, background: p.tertiaryContainer, color: p.onTertiaryContainer, letterSpacing: 0.4 }}>DEVELOPING PHASE</span>
);
      ...
      {open && (
        ...
        >
          ...
          >
            ...
            {/* Developing phase notice banner */}
            <div
              style={{
                display: "flex",
                alignItems: "center",
            ...
            >
              ...
              <span>
                <strong>Developing Phase:</strong> AI prompt drafting and direct synthesis are currently under active development. Background prompt generation and tools remain fully active.
              </span>
            </div>
